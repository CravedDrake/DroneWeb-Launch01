...
{ id: 2, title: 'Phantom 3 SE', description: 'Reliable. Precise. Ready.', image: '/phantom 3 se.jpg' },
{ id: 3, title: 'Mavic 2 Zoom', description: 'Zoom-capable aerial imaging.', image: '/mavic_2_zoom.jpg' },
{ id: 4, title: 'Explorer Kit', description: 'Everything you need to start flying.', image: '/explorer_kit.jpg' },
];


const products = [
{ id: 1, name: 'Mavic Air', price: '$999', image: '/mavi_air.jpg', featured: true },
{ id: 2, name: 'Phantom 3 SE', price: '$899', image: '/phantom 3 se.jpg', featured: true },
{ id: 3, name: 'Mavic 2 Zoom', price: '$1299', image: '/mavic_2_zoom.jpg' },
{ id: 4, name: 'Starter Accessory Pack', price: '$79', image: '/explorer_kit.jpg' },
{ id: 5, name: 'Spare Propeller Set', price: '$19', image: '/propeller_set.jpg' },
];
...
export default function HomePage() {
  ...
  function HeroCarousel() {
    ...
    return (
      <div className="relative w-full h-80 md:h-110 rounded-xl overflow-hidden shadow-lg">
        {banners.map((b, i) => (
          <div
            key={b.id}
          ...
          >
            ...
            <div className="relative w-full h-screen overflow-hidden brightness-75">
  <img
    src={b.image}
    alt={b.title}
  ...
  <h2 className="text-3xl md:text-5xl font-extrabold text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)]">
    {b.title}
  </h2>
  <p className="mt-2 text-sm md:text-base text-white drop-shadow-[0_1px_6px_rgba(0,0,0,0.6)] max-w-md">
    {b.description}
  </p>
  <div className="mt-4">
